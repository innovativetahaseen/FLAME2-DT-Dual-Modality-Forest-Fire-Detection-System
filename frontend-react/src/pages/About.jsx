      ...
      <div className="team-container">
        ...
        <div className="team-card">
          ...
          <div className="social">
            ...
            <a
              href= "https://github.com/Bhartichaudhary-git"
              target="_blank"
            >
              GitHub
            </a>
            ...
            <a
              href="https://www.linkedin.com/in/bharti-chaudhary-a00a14349?utm_source=share_via&utm_content=profile&utm_medium=member_android"
              target="_blank"
            >
              LinkedIn
            </a>
        ...
        <div className="team-card">
          ...
          <div className="social">
            ...
            <a
              href="https://github.com/innovativetahaseen"
              target="_blank"
            >
              GitHub
            </a>
            ...
            <a
              href="https://www.linkedin.com/in/tahaseen-khan-78a18a324?utm_source=share_via&utm_content=profile&utm_medium=member_android"
              target="_blank"
            >
              LinkedIn
            </a>
        ...
        <div className="team-card">
          ...
          <div className="social">
            ...
            <a
              href="https://www.linkedin.com/in/shaurya-singhal-b0979a165?utm_source=share_via&utm_content=profile&utm_medium=member_android"
              target="_blank"
            >
              LinkedIn
            </a>
